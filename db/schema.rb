...
ActiveRecord::Schema.define(version: 2019_02_28_192419) do
  ...
  create_table "activity_dates", id: :serial, force: :cascade do |t|
    ...
    t.index ["date"], name: "index_activity_dates_on_date"
    t.index ["start_time"], name: "index_activity_dates_on_start_time"
  end

  create_table "activity_participations", id: :serial, force: :cascade do |t|
    t.integer "activity_date_id", null: false
    ...
    t.bigint "session_id"
    t.index ["activity_date_id"], name: "index_activity_participations_on_activity_date_id"
  ...
  create_table "activity_presets", force: :cascade do |t|
    ...
    t.jsonb "place_urls", default: {}, null: false
    t.jsonb "activities", default: {}, null: false
    t.index ["places", "activities"], name: "index_activity_presets_on_places_and_activities", unique: true
  end
  ...
  create_table "basket_sizes", id: :serial, force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.decimal "price", precision: 8, scale: 3, default: "0.0", null: false
    t.integer "activity_demanded", default: 0, null: false
    t.jsonb "names", default: {}, null: false
  ...
  create_table "invoices", id: :serial, force: :cascade do |t|
    ...
    t.bigint "object_id"
    t.integer "paid_missing_activity"
  ...
  create_table "memberships", id: :serial, force: :cascade do |t|
    ...
    t.integer "activity_demanded", default: 0, null: false
    t.integer "activity_accepted", default: 0, null: false
  ...
  add_foreign_key "activity_participations", "activity_dates"
