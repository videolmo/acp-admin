ActiveAdmin.register Invoice do
  ...
  form do |f|
    ...
    tabs do
      tab activity_human_name, id: 'activity_participation' do
        f.inputs do
  ...
  before_build do |invoice|
    if params[:activity_participation_id]
      hp = ActivityParticipation.find(params[:activity_participation_id])
      invoice.member = hp.member
      invoice.object = hp
      invoice.paid_missing_activity_participations = hp.participants_count
      invoice.paid_missing_activity_participations_amount = hp.participants_count * ACP::HALFDAY_PRICE
    ...
    invoice.paid_missing_activity_participations_amount ||= ACP::HALFDAY_PRICE
