ActiveAdmin.register Membership do
  ...
  show do |m|
    columns do
      ...
      column do
        ...
        attributes_table title: activity_human_name do
          row(:activity_participations_asked) { m.activity_participations }
  ...
  form do |f|
    ...
    unless resource.new_record?
      f.inputs activity_human_name do
        f.input :activity_participations_demanded_annualy,
          label: "#{activity_human_name} (#{t('.full_year')})",
          hint: true
