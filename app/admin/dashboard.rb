      ...
      column do
        ...
        panel t('.billing_year', fiscal_year: Current.fy_year) do
          ...
          table_for nil do
            column do
              span do
                link_to t('.xlsx_recap'), billing_path(Current.fy_year, format: :xlsx)
              end
            end
          end
        end
        ...
        if next_delivery
          panel t('.next_delivery', date: l(next_delivery.date, format: :long)) do
            ...
            if counts.present?
              ...
              span do
                link_to t('.xlsx_recap'), delivery_path(Delivery.next, format: :xlsx)
              end
              span { '&nbsp;/&nbsp;'.html_safe }
              span do
                link_to t('.signature_sheets'), delivery_path(Delivery.next, format: :pdf)
              end
