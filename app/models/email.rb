module Email
  ...
  def activity_participation_data(activity_participation)
    halfday = activity_participation.activity

    data = {
      activity_date: I18n.l(activity.date),
      activity_date_long: I18n.l(activity.date, format: :long),
      halfday_period: activity.period,
      halfday_activity: activity.activity,
      halfday_description: activity.description,
      halfday_participants_count: activity_participation.participants_count
    }
